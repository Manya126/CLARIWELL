            ...
            <form onSubmit={handleSubmit} className='space-y-8'>
              <div className='flex sm:flex-row flex-col gap-4'>
                <input
                  ...
                  placeholder='Name'
                  value={name}
                  className='w-full p-4 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-600 shadow'
                />
                <input
              ...
              <textarea
                ...
                rows='5'
              ></textarea>
              <button type='submit' className='w-full p-3 bg-pink-700 text-white rounded-md hover:bg-pink-700'>
                Send Message
              </button>
            </form>
          </motion.div>
